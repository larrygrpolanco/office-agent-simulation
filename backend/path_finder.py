"""
Path finding utilities for generative agents.
Legacy-compatible and modernized, ported from og_path_finder.py.
"""
...
def path_finder_3(maze, start, end, collision_block_char="#", verbose=False):
    ...
    curr_path = path_finder(maze, start, end, collision_block_char, verbose=verbose)
    if len(curr_path) <= 2:
        return []
    else:
...
# Legacy main test block (optional, can be removed in production)
